...
// https://codemyui.com/cheesy-pizza-loader/
  ...
  useEffect(() => {
    ...
    class Pizza {
      constructor(id) {
        ...
        this.width = this.sliceSize * 2 + 50;
        this.height = this.sliceSize * 2 + 50;
        this.canvas.height = this.sliceSize * 2 + 50;
        this.canvas.width = this.sliceSize * 2 + 50;
        // this.sliceSize * 2 + 50;
